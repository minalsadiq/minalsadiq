...
**10-Year Coronary Heart Disease Risk Prediction & Clinical Decision Support System**

An end-to-end machine learning project focused on predicting **10-year CHD risk** using clinical and demographic data.
...
* 🔹 Clinical/business-oriented insights
* 🔹 Interactive Streamlit deployment

🔗 **[GitHub Repository](https://github.com/minalsadiq/framingham_chd_project)**
🚀 **[Live Streamlit App](https://framinghamchdproject-rvthlda8j6unhf6kqjmc3a.streamlit.app/)**

---

#### 🏦 Bank Marketing Prediction

**Predicting Customer Subscription to a Term Deposit**

An end-to-end classification project using the **Bank Marketing dataset** to predict customer subscription behavior.
...
**Models explored:** Logistic Regression, Random Forest, Gradient Boosting, XGBoost, LightGBM, CatBoost & MLP.
...
A machine learning project focused on identifying customers who are more likely to **churn** and extracting actionable business insights.
